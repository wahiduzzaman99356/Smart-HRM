...
const MOCK_QUESTIONS: Question[] = [
  {
    id: 'Q-1825',
    text: 'Which of the following are valid HTML5 semantic elements?',
    type: 'MULTISELECT',
    topic: 'Web Protocols',
    ...
    performance: { used: 12, successRate: 45 },
  },
  {
    id: 'Q-1826',
    text: 'Explain the difference between optimistic and pessimistic locking in database transactions.',
    type: 'DESCRIPTIVE',
    topic: 'Database',
  ...
  },
  {
    ...
    performance: { used: 18, successRate: 72 },
  },
  {
    id: 'Q-1828',
    text: 'Which HTTP methods are considered idempotent?',
    type: 'MULTISELECT',
    topic: 'HTTP',
    targetRole: 'Mid-level Developer',
    department: 'Engineering',
    difficulty: 'Medium',
    status: 'active',
    createdBy: { name: 'John Taylor', initials: 'J', color: '#64748b' },
    createdAt: '2026-02-08',
    performance: { used: 9, successRate: 55 },
  },
  {
    id: 'Q-1829',
    text: 'Describe the CAP theorem and its practical implications for distributed systems.',
    type: 'DESCRIPTIVE',
    topic: 'System Design',
    ...
    performance: { used: 6, successRate: 38 },
  },
  {
    id: 'Q-1830',
    text: 'True or False: REST APIs are inherently stateless.',
    type: 'TRUE_FALSE',
    topic: 'REST APIs',
    ...
    difficulty: 'Easy',
    status: 'active',
    createdBy: { name: 'David Kim', initials: 'D', color: '#64748b' },
    createdAt: '2026-02-03',
    performance: { used: 24, successRate: 88 },
  },
  {
    id: 'Q-1831',
    ...
    performance: { used: 15, successRate: 60 },
  },
  {
    id: 'Q-1832',
    text: 'Explain all five SOLID principles with real-world code examples.',
    type: 'DESCRIPTIVE',
    ...
    performance: { used: 8, successRate: 42 },
  },
  {
    id: 'Q-1833',
    text: 'What are the primary benefits of microservices over a monolithic architecture?',
    type: 'DESCRIPTIVE',
    topic: 'Architecture',
    targetRole: 'Architect',
    department: 'Engineering',
  ...
  {
    id: 'Q-1834',
    text: 'Which design pattern is implemented by React\'s Context API?',
    type: 'MCQ',
    topic: 'React',
    targetRole: 'Mid-level Developer',
    department: 'Engineering',
  ...
  },
  {
    ...
    performance: { used: 45, successRate: 82 },
  },
  {
    id: 'Q-1201',
    text: 'Describe the key phases in the software development lifecycle (SDLC).',
    type: 'DESCRIPTIVE',
    topic: 'SDLC',
    ...
    performance: { used: 32, successRate: 65 },
  },
];
...
export default function QuestionBankPage() {
  ...
  const filteredData = useMemo(() => {
    ...
    return MOCK_QUESTIONS.filter(item => {
